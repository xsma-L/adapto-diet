    ...
    <main className="">
      ...
      <section className="h-full w-full lg:h-fit lg:flex lg:justify-center lg:align-center">
        <div className="px-6 text-center mt-10 py-5 lg:mt-0 lg:w-[80%] lg:flex lg:flex-row-reverse lg:items-center lg:justify-around">
          <div className="w-60 h-[11rem] relative mt-3 mb-6 mx-auto lg:basis-2/5 lg:h-[18rem] lg:mt-0 lg:mx-0">
            <Image src="/fruits.svg" fill={true} alt="Panier équilibré repmlit de légumes et protéines" />
          </div>
          <div className="basis-1/2">
      ...
      <section className="h-full w-full lg:h-fit lg:flex lg:justify-center lg:align-center">
        <div className="px-6 text-center mt-10 py-5 lg:mt-0 lg:w-[80%] lg:flex lg:flex-row-reverse lg:items-center lg:justify-around">
          <div className="w-60 h-[11rem] relative mt-3 mb-6 mx-auto lg:basis-2/5 lg:h-[18rem] lg:mt-0 lg:mx-0">
            <Image src="/gourmandise.webp" fill={true} alt="Repas équilibré créé avec l'aide d'une intelligence artificielle" />
          </div>
          <div className="basis-1/2">
